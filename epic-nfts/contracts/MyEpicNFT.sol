...
contract MyEpicNFT is ERC721URIStorage {
  ...
  // separate to two parts in order to give random color.
  string svgPartOne = "<svg xmlns='http://www.w3.org/2000/svg' preserveAspectRatio='xMinYMin meet' viewBox='0 0 350 350'><style>.base { fill: white; font-family: serif; font-size: 24px; }</style><rect width='100%' height='100%' fill='";
  string svgPartTwo = "'/><text x='50%' y='50%' class='base' dominant-baseline='middle' text-anchor='middle'>";

  string[] firstWords = ["ElonMusk", "", "MichaelSaylor", "AnatolyYakovenko", "RajGokal", "VitalikButerin"];
  string[] secondWords = ["Fantastic", "MeMe", "Terrible", "Bullish", "Crazy", "YOUR_WORD"];
  string[] thirdWords = ["Bitcoin", "Ethereum", "Solana", "Binance", "Tezos", "Flow"];
        ...
        bytes(
            string(
                abi.encodePacked(
                    ...
                    combinedWord,
                    '", "description": "A highly acclaimed collection of magic.", "image": "data:image/svg+xml;base64,',
